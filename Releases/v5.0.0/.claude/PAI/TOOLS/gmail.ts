...
//   2. PAI shared USER credentials (PAI_DATA_DIR/USER/CREDENTIALS/google/credentials.json)

import { readFileSync } from "node:fs";
import { expandHome, userPath } from "./lib/paths";

const CREDS_PATH = process.env.GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE
  ? expandHome(process.env.GOOGLE_WORKSPACE_CLI_CREDENTIALS_FILE)
  : userPath("CREDENTIALS", "google", "credentials.json");
